$(document).ready(function () {
    ...
    $("#txtDescription").Watermark("Anything in particular you want us to focus on during the demo?");
    $("#txtHeard").Watermark("How did you hear about Assette?");
...
function checkFormInputs() {
    ...
    if (description == "Anything in particular you want us to focus on during the demo?") description = "";
    if (heard == "How did you hear about Assette?") heard = "";
