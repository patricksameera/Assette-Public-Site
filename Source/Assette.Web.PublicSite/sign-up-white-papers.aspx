<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sign-up-white-papers.aspx.cs"
    Inherits="Assette.Web.PublicSite.sign_up_white_papers" %>
...
<head id="Head1" runat="server">
    ...
    <script src="scripts/download-paper.js" type="text/javascript"></script>
...
<body class="signup_body">
    ...
    <div class="sign_up">
        ...
        <div class="download_white_paper_description">
            Thank you for your interest in Assette's whitepapers. Please complete the information
            below and click "Submit" to read the white paper.
            <br />
            <br />
