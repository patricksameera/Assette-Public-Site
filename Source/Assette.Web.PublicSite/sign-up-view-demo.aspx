<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sign-up-view-demo.aspx.cs"
    Inherits="Assette.Web.PublicSite.sign_up_view_demo" %>
...
<head id="Head1" runat="server">
    ...
    <script src="scripts/view-demo.js" type="text/javascript"></script>
    ...
    <div class="sign_up">
        <div class="signup_title">
            <img src="images/double_arrow.png?v=<%= ConfigurationSettings.AppSettings["Version"] %>"
                alt="" width="20" height="20" style="float: left;" />
            <div id="demo_product" style="float: left;" runat="server">
            </div>
            &nbsp;-&nbsp;Watch Demo</div>
        <div class="view_demo_description">
            <div id="demo_time" runat="server">
            </div>
            <%--<br />--%>
            <br />
        ...
        <div class="requird_text">
            * Required</div>
        <div class="field_row_long" style="height: 10px;">
            &nbsp;
        </div>
