...
{
    public partial class request_demo : ClientBasePage
    {
        ...
        protected void btnRegister_Click(object sender, EventArgs e)
        {
            ...
            if (description == "Anything in particular you want us to focus on during the demo?")
            {
            ...
            string pageTitle = "Live Demo Request - " + product + " | Form";
            ...
            if (blnRet == true)
            {
                ...
                ScriptManager.RegisterStartupScript(this.Page, this.GetType(), "fancyboxclosescript", "<script type='text/javascript'>requestDemoSucess();</script>", false);
            }
        }
    }
}