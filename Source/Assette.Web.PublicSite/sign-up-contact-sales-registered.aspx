<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sign-up-contact-sales-registered.aspx.cs"
    Inherits="Assette.Web.PublicSite.sign_up_contact_sales_registered" Title="Contact Assette" %>
...
<head id="Head1" runat="server">
    ...
    <script src="scripts/contact-sales-registered.js" type="text/javascript"></script>
...
<body class="signup_body">
    ...
    <div class="sign_up">
        <div class="signup_title">
            Contact Assette</div>
        <div class="contatc_sales_description">
            Thank you for your interest in Assette. Please complete the information below and
            click "Submit". An Assette representative will contact you within 1 business day
            to discuss your client communications needs.
            <br />
            <br />
            <%--In the meantime, if you haven't already done so, click <a class="contact_sales_video_link lnkblue"
